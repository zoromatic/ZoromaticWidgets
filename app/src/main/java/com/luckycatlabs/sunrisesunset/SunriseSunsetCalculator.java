...
public class SunriseSunsetCalculator {
    ...
    private SunriseSunsetLocation sunriseSunsetLocation;

    private SolarEventCalculator calculator;

    /**
     * Constructs a new <code>SunriseSunsetCalculator</code> with the given <code>SunriseSunsetLocation</code>
     *
     * @param sunriseSunsetLocation <code>SunriseSunsetLocation</code> object containing the Latitude/Longitude of the sunriseSunsetLocation to compute
     ...
     *                              time zones.
     */
    public SunriseSunsetCalculator(SunriseSunsetLocation sunriseSunsetLocation, String timeZoneIdentifier) {
        this.calculator = new SolarEventCalculator(sunriseSunsetLocation, timeZoneIdentifier);
    }
     ...
     */
    public SunriseSunsetCalculator(SunriseSunsetLocation sunriseSunsetLocation, TimeZone timeZone) {
        this.calculator = new SolarEventCalculator(sunriseSunsetLocation, timeZone);
    }
     ...
     *
     * @param latitude
     * @param longitude Coordinates for the sunriseSunsetLocation to compute the sunrise/sunset for.
     * @param timeZone  timezone to compute the sunrise/sunset times in.
     * @param date      <code>Calendar</code> object containing the date to compute the official sunset for.
    ...
    public static Calendar getSunrise(double latitude, double longitude, TimeZone timeZone, Calendar date, double degrees) {
        SolarEventCalculator solarEventCalculator = new SolarEventCalculator(new SunriseSunsetLocation(latitude, longitude), timeZone);
    ...
    /**
     * Returns the sunriseSunsetLocation where the sunrise/sunset is calculated for.
     *
     * @return <code>SunriseSunsetLocation</code> object representing the sunriseSunsetLocation of the computed sunrise/sunset.
     */
    public SunriseSunsetLocation getLocation() {
        return sunriseSunsetLocation;
    }
}
